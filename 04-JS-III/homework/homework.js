...
function breakStatement(numero) {
  ...
  // Tu código:
  // En el for i comienzo del 1 porque no necesito recorrer un array sino sumar un numero x 10 veces por dos su valor. (podria haber comenzando desde el cero )
  var nuevoArray = [];
  var suma = numero;
  for(var i = 1; i <= 10; i++){
    suma = suma + 2;
